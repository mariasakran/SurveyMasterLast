...
export class SurveyService {
  ...
  getSurveysByCategory(category: string): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/getByCategory/${category}`);
  }
  ...
  getAcceptedSurvey(): Observable<any> {
    return this.http.get<any[]>(`${this.apiUrl}/getAcceptedSurvey`);
  }
  ...
  deleteNotifications(userId: number): Observable<any> {
    return this.http.delete<any>(
      `${this.apiUrl1}/deleteNotificationByUserId/${userId}`
    );
  }
  deleteNotification(notificationId: number) {
    return this.http
      .delete(`${this.apiUrl1}/deleteNotificationById/${notificationId}`)
      .subscribe({});
  }
  addRadioResult(
    questionId: number,
    ...
    return this.http.put(
      `${this.apiUrl}/radioResult/${questionId}/${index}/${surveyId}/${userId}`,
      {}
    );
  }
  addStringResult(
    ...
    return this.http.put(
      `${this.apiUrl}/textResult/${questionId}/${surveyId}/${userId}`,
      answer
    );
  }
  addaddChickBoxResult(
    questionId: number,
    indexes: any,
    surveyId: number,
    userId: number
    ...
    return this.http.put(
      `${this.apiUrl}/checkBoxResult/${questionId}/${surveyId}/${userId}`,
      indexes
    );
  }
